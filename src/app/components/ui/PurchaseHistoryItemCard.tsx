...
const PurchaseHistoryItemCard: React.FC<PurchaseItemCardProps> = ({
  ...
  return (
    <div className="flex gap-4 p-4 border border-gray-100 rounded-md bg-gray-50">
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-600">{item.nft.type.name}</p>
      ...
      <div className="text-right">
        ...
        <p className="text-xs text-gray-500">${item.priceAtPurchase} each</p>
      </div>
    </div>
  );
};
